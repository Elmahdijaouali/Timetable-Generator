...
export default function PopupError({
  ...
  return (
    <div className="absolute left-0 bg-black/50 top-0 w-full h-full flex justify-between items-center z-50" onClick={() => setAfficherPopupError(false)}>
