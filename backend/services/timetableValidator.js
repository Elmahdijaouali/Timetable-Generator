...
class TimetableValidator {
  ...
  static async validateTimetable(timetable, group, requiredSessions) {
    try {
      console.log(`Validating timetable for group: ${group.code_group}`);
      ...
      console.log(`Timetable validation completed for ${group.code_group}: ${validationResults.isValid ? 'VALID' : 'INVALID'}`);
